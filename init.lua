...
require('lazy').setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('FileType', {
        ...
        callback = function()
          ...
          vim.opt_local.foldexpr = "v:lua.require'markdown'.foldexpr()"
...

  {
    ...
    ft = 'markdown',
    init = function()
      -- abilita il folding automatico di vim-markdown
      vim.g.vim_markdown_folding_disabled = 0
    end,
    config = function()
      -- quando apri un .md, imposta foldmethod/expr su MarkdownFold()
      vim.api.nvim_create_autocmd('FileType', {
        pattern = 'markdown',
        callback = function()
          vim.opt_local.foldmethod = 'expr'
          ...
          vim.opt_local.foldenable = true
          -- mostra tutto all’avvio (puoi abbassare a 1 se vuoi)
...
--nvim-treesitter per sintassi equazioni markdown
-- Abilita il folding con treesitter
